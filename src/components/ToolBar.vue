...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                items: [
                    ...
                    {
                        title: '地理分析', icon: 'mdi-account-group-outline',
                        subItems: [
                            {title: '通视分析', icon: 'mdi-compass-outline', id: 'sight'},
                            {title: '可视域分析', icon: 'mdi-compass-outline', id: 'visibility'},
                            {title: '限高分析', icon: 'mdi-compass-outline', id: 'limitHeight'},
                            {title: '缓冲区分析', icon: 'mdi-compass-outline', id: 'buffer'},
                            {title: '填挖分析', icon: 'mdi-compass-outline', id: 'digTerrain'}
                        ]
                    },
                    {
        ...
        methods: {
            ...mapMutations(['initOptions']),
            handleTool(subItem) {
                switch (subItem.id) {
                    case 'sight': {
                        this.initOptions(subItem.id)
                        break;
                    }
                    case 'visibility': {
                        this.initOptions(subItem.id)
